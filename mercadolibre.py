...
class TestingMercadoLibre(unittest.TestCase):
    ...
    def test_search_ps4(self):
        ...
        higher_price = driver.find_element_by_css_selector(
            '#root-app > div > div > section > div.ui-search-view-options__container > div > div > div > div.ui-search-sort-filter > div > div > div > ul > li:nth-child(3) > a')
        higher_price.click()
        sleep(3)
        ...
        for i in range(5):
            ...
            article_price = driver.find_element_by_xpath(
                f'//*[@id="root-app"]/div/div/section/ol/li[{i + 1}]/div/div/div[2]/div[2]/div[1]/div[1]/a/div/div/span[1]/span[2]/span[2]').text
